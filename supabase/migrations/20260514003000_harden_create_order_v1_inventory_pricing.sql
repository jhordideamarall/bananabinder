-- Migration: harden create_order_v1 for atomic inventory, server-side pricing, and accounting totals
-- Date: 2026-05-14
-- Context:
-- - Prevent overselling with SELECT ... FOR UPDATE row locks.
-- - Recalculate price, tax, HPP, and profit on the database side.
-- - Keep frontend payload shape compatible with packages/api-client/src/orders.ts.
...
BEGIN
  ...
  INSERT INTO public.orders (
    ...
    0,
    p_shipping_courier,
    p_shipping_courier_code,
    p_shipping_service_code,
    0,
    'pending',
    'unpaid'
  );
  ...
  LOOP
    ...
    INSERT INTO public.stock_movements (
      ...
      'order',
      v_order_id,
      'Stock reserved by create_order_v1',
      p_user_id
    );
  END LOOP;
