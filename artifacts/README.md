...
| Artifact                                                         | Fokus                                                                          |
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `070-2026-08-16-mobile-cart-variant-checkout-recovery.md`        | Recovery cart HP lama, auto-select varian tunggal, dan konsistensi harga RPC   |
| `069-2026-08-16-shipping-rate-accuracy-and-cod-toggle.md`        | Canonical Biteship weights, cheapest default, and admin COD toggle             |
