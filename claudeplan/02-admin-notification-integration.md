...
CREATE TABLE public.notifications (
    ...
    type VARCHAR(50) NOT NULL, -- 'order', 'payment', 'shipping', 'promo', 'broadcast'
    title TEXT NOT NULL,
    body TEXT NOT NULL,
    metadata JSONB DEFAULT '{}'::jsonb, -- Store order_id, product_id, campaign_id, etc.
...
4. [ ] **Admin Integration**:
   ...
   - Add notification triggers to order, payment, shipping, and promo management flows.
