...
import { IconArrowRight, IconStar, IconTruck, IconShieldCheck, IconSparkles } from "@tabler/icons-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 leading-[1.1]">
              Tulis Ceritamu di <span className="text-primary italic">Binder</span> Impian.
            </h1>
            <p className="mt-6 text-xl text-gray-500 max-w-lg">
              Binder custom dengan desain estetik dan kualitas premium. Cocok untuk menemanimu belajar, bekerja, dan journaling setiap hari.
            </p>
          ...
          <div className="relative hidden md:block">
             ...
             <div className="absolute -bottom-6 -left-6 glass p-6 rounded-2xl shadow-xl max-w-xs animate-bounce">
                ...
                <p className="text-sm font-medium">"Bindernya cakep banget, bahannya tebel dan ring-nya kokoh. Recommended!"</p>
                <p className="text-xs text-gray-500 mt-2">— Sarah, Mahasiswa UI</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex items-start gap-4 p-6 rounded-2xl bg-primary/5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Kirim ke seluruh Indonesia dengan packing aman.</p>
          </div>
        </div>
        <div className="flex items-start gap-4 p-6 rounded-2xl bg-secondary/5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Menggunakan bahan cover terbaik dan ring anti karat.</p>
          </div>
        </div>
        <div className="flex items-start gap-4 p-6 rounded-2xl bg-accent/10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Varian warna pastel dan desain yang up-to-date.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-10">
          <div>
            ...
            <p className="text-gray-500 mt-2">Koleksi binder terbaik yang paling dicintai pelanggan.</p>
          </div>
                ...
                <CardContent className="p-0">
                  <div className="aspect-[4/5] bg-gray-100 rounded-t-xl overflow-hidden relative">
                    ...
                    {product.product_variants?.[0]?.stock < 10 && (
                      <Badge variant="destructive" className="absolute top-2 left-2">Stok Menipis</Badge>
                    )}
                  </div>
                  <div className="p-4">
                    <h3 className="font-bold text-gray-900 group-hover:text-primary transition-colors line-clamp-1">{product.name}</h3>
                    <p className="text-primary font-bold mt-1">Rp {product.base_price.toLocaleString('id-ID')}</p>
