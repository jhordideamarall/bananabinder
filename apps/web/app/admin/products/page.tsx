  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-black text-gray-900">Products Catalog</h2>
          <p className="text-gray-500 font-medium">Kelola semua binder dan varian produk kamu.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product) => (
          <Card key={product.id} className="border-none shadow-xl shadow-gray-100/50 overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-gray-400 text-sm font-medium mt-1 line-clamp-1">{product.description}</p>
              
              <div className="flex items-center gap-4 mt-4 py-4 border-y border-gray-50">
                <div className="flex items-center gap-1.5">
                  <IconStack2 className="w-4 h-4 text-gray-400" />
                  <span className="text-xs font-bold text-gray-600">{product.productVariants.length} Varian</span>
                </div>
