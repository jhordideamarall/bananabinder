...
const AddressMapPicker = dynamic(
  () => import("@/components/AddressMapPicker"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[400px] w-full bg-gray-100 animate-pulse rounded-3xl" />
    ),
  }
);
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 font-medium">
            Pin lokasi Anda untuk pengiriman yang presisi.
          </p>
        </div>
      </div>
          ...
          {formData.area_name && (
            <div className="p-4 bg-primary/5 rounded-2xl flex items-center gap-3 border border-primary/10">
              ...
              <span className="text-xs font-bold text-primary">
                Area Terdeteksi:{" "}
                <span className="uppercase">{formData.area_name}</span>
              </span>
            </div>
          )}
        </section>
